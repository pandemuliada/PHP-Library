...
<head>
  ...
  <title>UrLibary - Tambah Data Kategori</title>
                  ...
                  <div class="row">
                    ...
                    <?php if (isset($_SESSION['success_msg'])) : ?>
                      <div class="alert alert-success">
                        Berhasil menambahkan data kategori ! <a href="list_kategori.php" class="alert-link">Lihat Hasil</a>
                      </div>
                    <?php endif; ?>
                    ...
                    <?php unset($_SESSION['success_msg']); ?>
                      ...
                      <form method="POST" action="proses_tambah.php" class="">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama_kategori" class="form-control mb-4" placeholder="Nama Kategori">
                        </div>
