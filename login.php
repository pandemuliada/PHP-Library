          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form method="POST" action="proses_login.php" class="pt-3">
                ...
                <div class="mt-3">
                  <input type="submit" name="submit" value="LOGIN" class="btn btn-block btn-gradient-primary btn-md font-weight-bold auth-form-btn text-white">
                </div>
