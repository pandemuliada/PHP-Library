...
<head>
  ...
  <title>UrLibary - List Buku</title>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                      <a href="form_tambah.php" class="btn btn-info btn-block">Tambah Buku</a>
                    </div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-12">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($data_buku as $buku) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="form_edit.php?id_buku=<?= $buku['id_buku'] ?>" class="btn btn-gradient-info btn-xs"><i class="mdi mdi-pencil"></i></a>
                              <a href="hapus_buku.php?id_buku=<?= $buku['id_buku'] ?>" onclick="return confirm('Are you sure ?')" class="btn btn-gradient-danger btn-xs"><i class="mdi mdi-delete"></i></a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
